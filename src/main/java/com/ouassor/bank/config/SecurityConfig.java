package com.ouassor.bank.config;
...
import com.ouassor.bank.service.impl.UserSecurityService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	private static final String WAS = "was"; // Was should be protected carefully

	@Bean
	public BCryptPasswordEncoder passwordEncoder() {
		return new BCryptPasswordEncoder(12, new SecureRandom(WAS.getBytes()));
	}
...
//	                antMatchers("/**").
		...
		http.csrf().disable().cors().disable().formLogin().failureUrl("/index?error").defaultSuccessUrl("/ui")
